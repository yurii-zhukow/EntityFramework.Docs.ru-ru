...
---
# <a name="self-tracking-entities-walkthrough"></a>Пошаговое руководство по Self-Tracking сущностям
> [!IMPORTANT]
...
-   Меняет местами на шаблон генератора сущностей Self-Tracking.
...
Теперь необходимо отключить создание кода по умолчанию и переключить на Self-Tracking сущности.
...
-   Щелкните правой кнопкой мыши пустую область в области конструктора EF и выберите пункт **Добавить элемент создания кода...**
-   Выберите **код** на левой панели, а затем **ADO.NET Self-Trackingный Генератор сущностей** .
...
Чтобы использовать Self-Tracking сущности, клиентскому приложению требуется доступ к классам сущностей, созданным из нашей модели. Так как мы не хотим предоставлять клиентским приложениям всю модель, мы будем перемещать классы сущностей в отдельный проект.
