...
-   Если вы используете Visual Studio 2010
    -   SELECT **Data-&gt; редактор SQL Transact-&gt; создать соединение с запросом...**
...
-   **Файл-&gt; новый проект-&gt;...**
-   Выберите **Visual C @ no__t-1** в левой области, а затем **Библиотека классов** .
...
-   Выберите **генератор тавить для шаблона C @ no__t-1** , введите в качестве имени **стетемплате** и нажмите кнопку **добавить** .
...
-   **Файл-&gt; Add-&gt; проект...**
-   Выберите **Visual C @ no__t-1** в левой области, а затем — **приложение службы WCF** .
...
-   **Файл-&gt; новый проект-&gt;...**
-   Выберите **Visual C @ no__t-1** в левой области, а затем **консольное приложение** .
...
-   **Файл-&gt; новый проект-&gt;...**
-   Выберите **Visual C @ no__t-1** в левой области, а затем — **приложение WPF**
