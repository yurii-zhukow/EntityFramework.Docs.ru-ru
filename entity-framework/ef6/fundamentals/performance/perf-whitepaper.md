...
## <a name="2-cold-vs-warm-query-execution"></a>2. Холодный и Выполнение горячего запроса
...
| Написание кода для пользователя                                                                                     | Action                    | Влияние EF4 производительности на производительность                                                                                                                                                                                                                                                                                                                                                                                                        | Влияние EF5 производительности на производительность                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Влияние EF6 производительности на производительность                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|:-----------------------------------------------------------------------------------------------------|:--------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| `  var c1 = q1.First();`                                                                             | Выполнение запросов LINQ      | — Загрузка метаданных: Высокий, но кэшированный <br/> — Создание представления: Потенциально очень высокий, но кэшированный <br/> — Вычисление параметров: Средний <br/> -Преобразование запроса: Средний <br/> — Создание материализации: Средний, но кэшированный <br/> -Выполнение запроса к базе данных: Потенциально высокая <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний <br/> — Поиск удостоверения: Средний | — Загрузка метаданных: Высокий, но кэшированный <br/> — Создание представления: Потенциально очень высокий, но кэшированный <br/> — Вычисление параметров: Низкий <br/> -Преобразование запроса: Средний, но кэшированный <br/> — Создание материализации: Средний, но кэшированный <br/> -Выполнение запроса к базе данных: Потенциально высокая (более качественные запросы в некоторых ситуациях) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний <br/> — Поиск удостоверения: Средний | — Загрузка метаданных: Высокий, но кэшированный <br/> — Создание представления: Средний, но кэшированный <br/> — Вычисление параметров: Низкий <br/> -Преобразование запроса: Средний, но кэшированный <br/> — Создание материализации: Средний, но кэшированный <br/> -Выполнение запроса к базе данных: Потенциально высокая (более качественные запросы в некоторых ситуациях) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний (быстрее, чем EF5) <br/> — Поиск удостоверения: Средний |
...
| `using(var db = new MyContext())` <br/> `{`                                                          | Создание контекста          | Средний                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Средний                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var q1 = ` <br/> `    from c in db.Customers` <br/> `    where c.Id == id1` <br/> `    select c;` | Создание выражения запроса | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var c1 = q1.First();`                                                                             | Выполнение запросов LINQ      | — Поиск ~~загрузки~~ метаданных: ~~Высокий, но кэшированный~~ Низшую <br/> Просмотр ~~создания~~ представления: ~~Потенциально очень высокий, но кэшированный~~ Низшую <br/> — Вычисление параметров: Средний <br/> Поиск ~~перевода~~ запроса: Средний <br/> — Уточняющий запрос ~~создания~~ материализации: ~~Средний, но кэшированный~~ Низшую <br/> -Выполнение запроса к базе данных: Потенциально высокая <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний <br/> — Поиск удостоверения: Средний | — Поиск ~~загрузки~~ метаданных: ~~Высокий, но кэшированный~~ Низшую <br/> Просмотр ~~создания~~ представления: ~~Потенциально очень высокий, но кэшированный~~ Низшую <br/> — Вычисление параметров: Низкий <br/> Поиск ~~перевода~~ запроса: ~~Средний, но кэшированный~~ Низшую <br/> — Уточняющий запрос ~~создания~~ материализации: ~~Средний, но кэшированный~~ Низшую <br/> -Выполнение запроса к базе данных: Потенциально высокая (более качественные запросы в некоторых ситуациях) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний <br/> — Поиск удостоверения: Средний | — Поиск ~~загрузки~~ метаданных: ~~Высокий, но кэшированный~~ Низшую <br/> Просмотр ~~создания~~ представления: ~~Средний, но кэшированный~~ Низшую <br/> — Вычисление параметров: Низкий <br/> Поиск ~~перевода~~ запроса: ~~Средний, но кэшированный~~ Низшую <br/> — Уточняющий запрос ~~создания~~ материализации: ~~Средний, но кэшированный~~ Низшую <br/> -Выполнение запроса к базе данных: Потенциально высокая (более качественные запросы в некоторых ситуациях) <br/> + Connection. Open <br/> + Command. ExecuteReader <br/> + DataReader. Read <br/> Материализация объекта: Средний (быстрее, чем EF5) <br/> — Поиск удостоверения: Средний |
| `}`                                                                                                  | Подключение. закрыть          | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Низкий                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
*Примечание.*  when перемещение модели в отдельные сборки, не забывайте копировать строки подключения для модели в файл конфигурации приложения клиентского проекта.
...
-   Кэш планов запросов является общим для всех типов запросов: Объекты Entity SQL, LINQ to Entities и CompiledQuery.
...
| Проверка                                                                   | EF5 без кэша | EF5 в кэше | EF6 без кэша | EF6 в кэше |
|:-----------------------------------------------------------------------|:-------------|:-----------|:-------------|:-----------|
...
-   Использование IEnumerable @ no__t-0T @ no__t-1. Содержит @ no__t-2 @ no__t-3 (значение T).
...
### <a name="41-using-ienumerablelttgtcontainslttgtt-value"></a>4,1. Использование IEnumerable @ no__t-0T @ no__t-1. Содержит @ no__t-2T @ no__t-3 (T Value)

Entity Framework не кэширует запросы, которые вызывают IEnumerable @ no__t-0T @ no__t-1. Содержит параметр @ no__t-2T @ no__t-3 (T Value) для коллекции в памяти, так как значения коллекции считаются временными. Следующий пример запроса не будет кэшироваться, поэтому он всегда будет обрабатываться компилятором плана:
...
Entity Framework 6 содержит оптимизацию для методов IEnumerable @ no__t-0T @ no__t-1. Содержит @ no__t-2T @ no__t-3 (значение T) работает при выполнении запросов. Создаваемый код SQL гораздо быстрее для создания и чтения, и в большинстве случаев он также выполняется быстрее на сервере.
...
В этом комплексном случае Entity Framework 6 выполняет Entity Framework 5 из-за улучшений производительности в нескольких частях стека, включая гораздо более светлую инициализацию DbContext и быстрее Метадатаколлектион @ no__t-0T @ no__t-1.
...
### <a name="81-lazy-loading-vs-eager-loading"></a>8,1 отложенная загрузка и Активная загрузка
...
Entity Framework по умолчанию будет создавать код SQL с семантикой сравнения null C @ no__t-0. Рассмотрим следующий пример запроса:
...
Сведения о асинхронных задач программирования, которые помогут вам решить, если асинхронный улучшит производительность приложения посетите [http://msdn.microsoft.com/library/hh191443.aspx](https://msdn.microsoft.com/library/hh191443.aspx). Дополнительные сведения об использовании асинхронных операций с Entity Framework см. в разделе [Async Query и Save @ no__t-1.
...
В этом примере действие базы данных будет зарегистрировано в консоли, но свойство Log может быть настроено для вызова любого делегата Action @ no__t-0string @ no__t-1.
...
-   Программная среда Entity Framework 4
    -   Имя ОС: Windows Server 2008 R2 Enterprise SP1.
...
-   Два процессора:     Intel (R) Xeon (R) L5520 W3530 @ 2.27 ГГц, 2261 Mhz8 ГГц, 4 ядра, 84 логических процессоров.
-   2412 ГБ Рамрам.
...
-   Имя ОС: Windows Server 2008 R 28.1 Enterprise с пакетом обновления 1 (SP1).
-   SQL Server 2008 R22012.

##### <a name="11122-hardware-environment"></a>аппаратная среда 11.1.2.2

-   Один процессор: Intel (R) Xeon (R) L5520 @ 2.27 ГГц, 2261 Мхзес-1620 0 @ 3,60 ГГц, 4 ядра, 8 логических процессоров.
-   824 ГБ Рамрам.
...
Где MDF @ no__t-0SessionLogin @ no__t-1Time @ no__t-2Max () определяется в модели как:
