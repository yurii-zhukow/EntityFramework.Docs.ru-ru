...
> Источник IQueryable не реализует IDbAsyncEnumerable{0}. Можно использовать только те источники, которые реализуют IDbAsyncEnumerable для асинхронных операций Entity Framework. Дополнительные сведения см. [ http://go.microsoft.com/fwlink/?LinkId=287068 ](http://go.microsoft.com/fwlink/?LinkId=287068).  
