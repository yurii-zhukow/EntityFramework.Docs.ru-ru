...
Мы собираемся тестирования службы, который использует EF модели. Чтобы иметь возможность заменять наш контекст EF с версией в памяти для тестирования, мы определим, интерфейс, который будет реализовывать наш контекст EF (и double в памяти).
