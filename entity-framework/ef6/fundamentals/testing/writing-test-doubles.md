...
В этой статье рассматривается создание собственного тестового типа Double. Сведения об использовании инфраструктуры макетирования см. в разделе [тестирование с использованием инфраструктуры макетирования](xref:ef6/fundamentals/testing/mocking).  
