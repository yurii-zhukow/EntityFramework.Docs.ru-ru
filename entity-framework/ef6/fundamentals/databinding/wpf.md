...
-   **Файл-&gt; проект New-&gt;...**
-   Выберите  **Windows** в левой области и **впфаппликатион** на правой панели.
-   Введите в качестве имени  **впфвисефсампле**
-   Нажмите кнопку **ОК** .
...
-   Добавьте новый класс в **впфвисефсампле:**
    ...
    -   Выберите **класс** и введите  **продукта** для имени класса.
...
Если теперь открыть файл Category.cs (который вложен в ProductModel.tt), вы увидите, что коллекция Products имеет тип **ObservableCollection&lt;&gt;продукта** .
...
-   В диалоговом окне Выбор объектов данных unfold **впфвисефсампле** два раза и выберите **категорию** .  
...
-   В окне XAML щелкните элемент **окна&lt;** , чтобы выбрать главное окно.
