...
-   **CategoryViewSource** ресурсов и ** categoryDataGrid ** управления были добавлены в XAML. Дополнительные сведения о DataViewSources, см. в разделе http://bea.stollnitz.com/blog/?p=387.
...
После вызова в DbContext **SaveChanges**(), идентификаторы заполняются значениями сформированный базой данных. Так как мы вызывали метод **обновить**() после **SaveChanges**() **DataGrid** элементы управления обновляются с использованием новых значений.
