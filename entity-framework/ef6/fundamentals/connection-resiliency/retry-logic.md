...
### <a name="workaround-suspend-execution-strategy"></a>Инструкции по решению: Приостановка выполнения стратегии  
...
### <a name="workaround-manually-call-execution-strategy"></a>Инструкции по решению: Вручную вызвать стратегию выполнения  
