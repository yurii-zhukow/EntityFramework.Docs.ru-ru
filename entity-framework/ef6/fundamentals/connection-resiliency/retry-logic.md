...
### <a name="user-initiated-transactions-not-supported"></a>Транзакции не поддерживаются, инициированное пользователем  
...
#### <a name="whats-supported-efs-default-transaction-behavior"></a>Поддерживаемые: платформы EF по умолчанию поведение транзакции  
...
#### <a name="whats-not-supported-user-initiated-transactions"></a>Что не поддерживается: транзакции, инициированное пользователем  
...
#### <a name="possible-workarounds"></a>Возможные решения  

##### <a name="suspend-execution-strategy"></a>Приостановка выполнения стратегии  
...
##### <a name="manually-call-execution-strategy"></a>Вручную вызвать стратегию выполнения  
