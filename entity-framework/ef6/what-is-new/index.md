...
В мае 2018 г. была выпущена обновленная версия инструментов для EF6 в Visual Studio 2017 15.7.
Она содержит усовершенствования в некоторых распространенных проблемных областях:

- пересмотрены специальные возможности пользовательского интерфейса;
- решена проблема, связанная со снижением производительности SQL Server при реконструировании [#4](https://github.com/aspnet/entityframework6/issues/4);
- поддержка обновления модели из базы данных для крупных моделей на сервере SQL Server [#185](https://github.com/aspnet/EntityFramework6/issues/185).

Эта новая версия инструментов для EF устанавливает среду выполнения EF 6.2 при создании модели в новом проекте. В предыдущих версиях Visual Studio среду выполнения EF 6.2 (а также любую более раннюю версию EF) можно использовать, установив соответствующую версию пакета NuGet.
