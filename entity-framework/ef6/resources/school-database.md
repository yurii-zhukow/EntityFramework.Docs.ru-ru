...
> [!NOTE]
> Сервер базы данных, устанавливаемый с Visual Studio, отличается в зависимости от используемой версии Visual Studio. Дополнительные сведения о том, что следует использовать, см. в [выпусках Visual Studio](~/ef6/what-is-new/visual-studio.md) .  
