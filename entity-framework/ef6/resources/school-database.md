...
> [!NOTE]
> Сервер базы данных, устанавливаемый с Visual Studio, отличается в зависимости от используемой версии Visual Studio. Дополнительные сведения о том, что следует использовать, см. в [выпусках Visual Studio](xref:ef6/what-is-new/visual-studio) .  
...
- Если вы используете Visual Studio 2010  
    - Выберите **данные**  ->  **Редактор SQL**данных  ->  **создать соединение с запросом...**  
