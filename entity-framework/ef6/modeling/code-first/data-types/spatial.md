...
Помимо определения сущностей необходимо определить класс, производный от DbContext, и предоставляет свойства DbSet @ no__t-0TEntity @ no__t-1. Свойства DbSet @ no__t-0TEntity @ no__t-1 позволяют контексту понять, какие типы необходимо включить в модель.
...
1.  В главном меню Visual Studio 2012 выберите **View** - @ no__t-2 **Обозреватель объектов SQL Server**.
