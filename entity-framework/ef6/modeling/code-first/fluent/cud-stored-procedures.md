...
- Три хранимые процедуры под названием **\<type_name\>_Insert**, **\<** type_name\>_Update и **\<** type_name\>_Delete (например, Blog_Insert, Blog_Update и Blog_Delete).  
...
- Параметры будут ключевыми значениями для каждого типа. Имя каждого параметра, который **\<type_name\>_\<property_name**\>(например, Post_PostId и Tag_TagId).
