...
4.  Разверните узел **сопоставления с &lt; именем &gt; таблицы**   .
    Появится узел **сопоставления столбцов**   .
5.  Разверните узел **сопоставления столбцов**   .
    Появится список всех столбцов таблицы. Свойства по умолчанию (если таковые имеются), к которым соответствует таблица Columns, перечислены под заголовком **значение/свойство**   .
