...
> [!NOTE]
> Эта функция была добавлена в EF Core 2,1 под именем типов запросов. В EF Core 3,0 концепция была переименована в типы сущностей без ключей. Аннотация `[Keyless]` данных стала доступной в ефкоре 5,0.
...
- Необходимо настроить с заметкой `[Keyless]` данных или вызовом `.HasNoKey()` метода.
...
> [!TIP]
> Вы можете просмотреть [Пример](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/KeylessEntityTypes) этой статьи на сайте GitHub.
