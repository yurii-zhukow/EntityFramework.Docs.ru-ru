...
* Свойства без методов получения не сопоставляются с соглашением. (Таким образом, как правило, для сопоставления свойства, которые не должны сопоставляться, например вычисляемого свойства.)
...
* Конструктор закрыт, поскольку он является только когда-либо вызвать ядром EF и другой конструктор, открытый для общего использования.
