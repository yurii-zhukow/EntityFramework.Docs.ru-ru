...
* Конструктор может быть открытым, закрытым, или иметь любой уровень доступа. Однако прокси отложенной загрузки требуется, что конструктор доступен из наследуемого класса прокси-сервера. Обычно это означает, что либо открытый или защищенный.
