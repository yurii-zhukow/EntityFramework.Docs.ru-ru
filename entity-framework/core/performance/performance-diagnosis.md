...
> [!TIP]
> Полный проект теста производительности для источника ниже доступен [здесь](https://github.com/dotnet/EntityFramework.Docs/tree/main/samples/core/Benchmarks/AverageBlogRanking.cs). Рекомендуется скопировать его и использовать в качестве шаблона для собственных тестов производительности.
