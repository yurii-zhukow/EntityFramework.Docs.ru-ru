...
* Команды SQL применяются непосредственно средством, не предоставляя разработчику изменения для их проверки или изменения. Это может быть опасно в рабочей среде.
...
* Команды SQL применяются непосредственно программой, не предоставляя разработчику изменения для их проверки или изменения. Это может быть опасно в рабочей среде.
