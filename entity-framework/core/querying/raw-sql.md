...
* SQL-запросы могут использоваться для возврата только тех типов сущностей, которые являются частью вашей модели. В нашем журнале заказов есть усовершенствование, [позволяющее возвращать специальные типы из необработанных SQL-запросов ](https://github.com/aspnet/EntityFramework/issues/1862).
