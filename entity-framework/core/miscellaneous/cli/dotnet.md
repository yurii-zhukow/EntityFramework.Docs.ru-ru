...
| \<ПОСТАВЩИК >   | Поставщик для использования. (Например) Microsoft.EntityFrameworkCore.SqlServer) |
...
|                 | <nobr>--schema \<SCHEMA_NAME>...</nobr> | Схемы таблиц для создания типов сущностей для.                                              |
...
|         |                                                               |
|:--------|:--------------------------------------------------------------|
| \<FROM> | Начальный миграции. По умолчанию равно 0 (начальной базы данных). |
| \<TO>   | Окончания миграции. По умолчанию последней миграции.         |
