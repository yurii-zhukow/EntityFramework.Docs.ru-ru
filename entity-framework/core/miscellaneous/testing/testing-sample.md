...
#### <a name="the-no-locitem-entity-type"></a>ItemТип сущности
...
#### <a name="the-no-loctag-entity-type"></a>TagТип сущности
...
### <a name="the-no-locitemscontroller"></a>ItemsКонтроллер
