...
В предварительной версии 2 представлено важное дополнение от [Пола Миддлтона (Paul Middleton)](https://github.com/pmiddleton), позволяющее сопоставлять скалярные функции базы данных с заглушками методов, чтобы их можно было использовать в запросах LINQ и преобразовывать в SQL.
...
Подобные методы регистрируются автоматически. После регистрации методы вы можете использовать его в любом месте своих запросов.
...
- Вам нужно создать сопоставленную функцию в базе данных, так как миграции EF Core этого не делают.
