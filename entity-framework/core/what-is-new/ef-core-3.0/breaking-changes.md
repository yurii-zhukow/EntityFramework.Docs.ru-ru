...
Это изменение реализовано в EF Core 3.0, предварительная версия 4.
...
Это изменение реализовано в ASP.NET Core 3.0, предварительная версия 1. 
...
Это изменение реализовано в EF Core 3.0, предварительная версия 4, и соответствующей версии пакета SDK для .NET Core.
...
Это изменение реализовано в EF Core 3.0, предварительная версия 3.
...
Это изменение реализовано в EF Core 3.0, предварительная версия 2.
...
Это изменение реализовано в EF Core 3.0, предварительная версия 5.
...
До EF Core 3.0 свойство можно было указать с помощью строкового значения. Если свойство с таким именем не удавалось найти в типе CLR, компонент EF Core пытался сопоставить его с полем, используя правила соглашения.
```C#
private class Blog
{
    private int _id;
