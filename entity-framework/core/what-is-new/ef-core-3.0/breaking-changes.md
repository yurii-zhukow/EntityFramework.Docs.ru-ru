...
Начиная с версии 3.0 EF Core не будет пытаться использовать свойства для внешних ключей по соглашению, если они имеют такое же имя, что и свойство субъекта.
...
Начиная с EF Core 3.0, если резервное поле для свойства известно, то чтение и запись этого свойства всегда осуществляются с его помощью.
