...
| **ClientSetNull** (по умолчанию) | Свойства внешнего ключа имеют значения NULL | Отсутствуют                                   |
| **SetNull**                 | Свойства внешнего ключа имеют значения NULL | Свойства внешнего ключа имеют значения NULL |
| **Restrict**                | Отсутствуют                                   | Отсутствуют                                   |
...
| **ClientSetNull**     | Строки SaveChanges                  | Отсутствуют                                  |
