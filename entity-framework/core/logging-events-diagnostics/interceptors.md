...
> [!NOTE]
> Перехват базы данных появился в EF Core 3,0 и доступен только для поставщиков реляционных баз данных.
> Поддержка точки сохранения появилась в EF Core 5,0.
