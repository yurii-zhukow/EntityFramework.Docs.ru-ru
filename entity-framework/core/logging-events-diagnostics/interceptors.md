...
Первый этап обрабатывается перед отправкой изменений в базу данных с помощью переопределений `ISaveChangesInterceptor.SavingChanges` <!-- Issue #2748 --> перетаскивани `ISaveChangesInterceptor.SavingChangesAsync`<!-- Issue #2748 -->.
